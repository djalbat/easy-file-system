...
export { default as UpToggleSVGDiv } from "./div/svg/toggle/up";
export { default as DownToggleSVGDiv } from "./div/svg/toggle/down";
export { default as OpenRubbishBinDiv } from "./div/rubbishBin/open";
export { default as ClosedRubbishBinDiv } from "./div/rubbishBin/closed";
